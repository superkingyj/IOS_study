...
class DepartmentController: UITableViewController {
    ...
    let deparmentArray = ["임원", "영업부", "인사부", "경리부"]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let index_ = index{
            destController.departmentName = deparmentArray[index_]
        }
